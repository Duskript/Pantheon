...
echo -e "${GREEN}══════════════════════════════════════════${NC}"
echo ""
echo "To start gateways (do this in separate terminals or use systemd):"
echo ""
echo "  # You (Hephaestus) — Telegram bot"
echo "  cd ~/pantheon && hermes -p hephaestus gateway run"
echo ""
echo "  # Apollo — Telegram bot"
echo "  cd ~/pantheon && hermes -p apollo gateway run"
echo ""
echo "To set up systemd (auto-start on boot):"
echo "  hermes -p hephaestus gateway install"
echo "  hermes -p apollo gateway install"
echo ""
echo "CLI usage:"
echo "  hermes -p hephaestus  # Open interactive session as you"
echo "  hermes -p apollo      # Open interactive session as Apollo"
