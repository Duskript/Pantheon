...
#
# History: 3-backends (pre-P5a) → 4-backends P5a → 5-backends P5c →
#          5-backends Phase 4 (vector-hydration-safer-ranking).
# The baseline updates as the WEIGHTS dict evolves. Drift detection
