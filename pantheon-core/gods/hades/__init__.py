...
Runs as a cron job. Performs:
  1. Health checks — vector backend vs filesystem consistency, INDEX coverage
  2. Embed backfill — push unembedded filesystem files into the vector backend
...
Submodule layout:
  ...
  - `embed`   — Phase 2: _Embedder, vector client, embed_missing_files
