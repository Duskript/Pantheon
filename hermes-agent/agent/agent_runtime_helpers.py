    ...
    if function_name == "todo":
        ...
        def _execute(next_args: dict) -> Any:
            return _ra().handle_function_call(
                ...
                # Attribute post-tool-call interventions to the active model.
                # Downstream hooks (ichor-gates, observability) read these
                # to label forge logs with the model that generated the
                # tool call — fixes the "model: unknown" gap.
