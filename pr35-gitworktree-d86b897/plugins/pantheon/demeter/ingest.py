...
def ingest_file(
    ...
    *,
    ...
    Args:
        ...
        skip_embed: Skip vector-store embedding (for bulk operations).
    ...
    # Step 8: Embed into Zvec
    if not skip_embed:
        _embed_into_zvec(str(dest_path), target_codex)
...
def _embed_into_zvec(file_path: str, codex: str) -> bool:
    """Embed a file into the Pantheon Zvec store.
    ...
    try:
        ...
        logger.debug("Not running inside Hermes — skipping Zvec embed")
        return False
